...
const AdminOpenPage: React.FC = () => {
  ...
  const handleResetAll = async () => {
    ...
    const result = await confirm(
      `Are you sure you want to PERMANENTLY DELETE ALL Open entries?\n\nThis will PERMANENTLY DELETE:\n• All Open transactions (0)\n• All admin deductions for Open entries\n\n🚨 THIS ACTION CANNOT BE UNDONE - ALL OPEN ENTRIES WILL BE PERMANENTLY DELETED FROM ALL PAGES!`,
      { type: 'danger', title: '🗑️ Delete All Open Entries Permanently' }
    );
    ...
    try {
      ...
      await showSuccess('Success', `Permanently deleted ${result.deletedCount} Open entries!`);
