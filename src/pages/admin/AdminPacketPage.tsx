...
const AdminPacketPage: React.FC = () => {
  ...
  const loadEntries = useCallback(async (force = false) => {
    ...
    try {
      ...
      const deductionData = await db.getAdminDeductionsByType('packet');
