...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // Mobile-first adaptive typography using clamp()
        'xs': ['clamp(0.625rem, 2.5vw, 0.75rem)', { lineHeight: '1.2', letterSpacing: '0.02em' }],
        'sm': ['clamp(0.75rem, 3vw, 0.875rem)', { lineHeight: '1.3', letterSpacing: '0.01em' }],
        'base': ['clamp(0.875rem, 3.5vw, 1rem)', { lineHeight: '1.6', letterSpacing: '0' }],
        'md': ['clamp(1rem, 4vw, 1.125rem)', { lineHeight: '1.6', letterSpacing: '0' }],
        'lg': ['clamp(1.125rem, 4.5vw, 1.25rem)', { lineHeight: '1.6', letterSpacing: '-0.01em' }],
        'xl': ['clamp(1.25rem, 5vw, 1.5rem)', { lineHeight: '1.5', letterSpacing: '-0.01em' }],
        '2xl': ['clamp(1.5rem, 6vw, 1.875rem)', { lineHeight: '1.4', letterSpacing: '-0.02em' }],
        '3xl': ['clamp(1.875rem, 7vw, 2.25rem)', { lineHeight: '1.3', letterSpacing: '-0.02em' }],
        '4xl': ['clamp(2.25rem, 8vw, 3rem)', { lineHeight: '1.2', letterSpacing: '-0.03em' }],
        '5xl': ['clamp(3rem, 10vw, 4rem)', { lineHeight: '1.1', letterSpacing: '-0.03em' }],
